...
import trainAsset from "@/assets/20260806_075744.jpg.asset.json";
  ...
  head: () => ({
    meta: [
      { title: "Edzésformák — Czakó Norbert személyi edző" },
      {
        name: "description",
        content:
          "Személyi edzés, páros edzés és online edzésterv a Peak Gymben, Budapesten. Válaszd ki a hozzád illő formát.",
      },
      { property: "og:title", content: "Edzésformák — Czakó Norbert" },
      {
        property: "og:description",
        content: "Személyi, páros és online edzési lehetőségek Budapesten.",
      },
    ],
  }),
  component: Edzesek,
...
const packages = [
  {
    ...
    desc: "Egy az egyben edzés a Peak Gymben, teljes technikai felügyelettel.",
    ...
    <div className="min-h-screen">
      ...
      <section className="grid border-b border-border/60 lg:grid-cols-2">
        ...
        <div className="relative min-h-[300px]">
          <img
            src={trainAsset.url}
            alt="Edzés a Peak Gym gépes részlegén"
